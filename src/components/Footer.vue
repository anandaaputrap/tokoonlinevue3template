<template>
  <footer class="bg-green-800 text-white py-8 px-4">
    <div class="max-w-6xl mx-auto">
      <div class="flex flex-col md:flex-row justify-between items-center">
        <div class="mb-4 md:mb-0">
          ...
          <p class="mt-2 text-sm text-green-200">
            Floral arrangements with celestial magic
          </p>
        </div>
      ...
      <div class="mt-8 pt-8 border-t border-green-700 text-center text-sm text-green-200">
        <p>&copy; 2025 Staryyist. All rights reserved.</p>
      </div>
    </div>
  </footer>
</template>
